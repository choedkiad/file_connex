...
$objPHPExcel->setActiveSheetIndex(0);
 ...
 $objPHPExcel->getActiveSheet()->setCellValue('AI1','คะแนนภาพประกอบ'); 
 $objPHPExcel->getActiveSheet()->setCellValue('AJ1','ผู้สร้าง'); 
 $objPHPExcel->getActiveSheet()->setCellValue('AK1','ผู้ติดต่อ'); 
 $objPHPExcel->getActiveSheet()->setCellValue('AL1','ห้อง PM'); 
 $objPHPExcel->getActiveSheet()->setCellValue('AM1','Remark'); 
 $objPHPExcel->getActiveSheet()->setCellValue('AN1','Remark2'); 
        ...
        if($ex_list_deal_type=='1'){ $ex_list_deal_type="ขาย";  $ex_list_deal_type_en="FOR SELL"; }else{$ex_list_deal_type="เช่า"; $ex_list_deal_type_en="FOR RENT";}
         ...
         if($rs_projects['project_id']!=''){  // project_id NO
                 ...
                 }else if($project_total_floors=='0' or $project_total_floors=='' ){

                      $project_total_floors=$ex_list_total_floors;
                 }
            ...
            if($ex_list_listing_type=='1'){ 
                  ...
                  $ex_list_floor = str_replace(" ","",$ex_list_floor,$count);
    ...
    if($_SESSION['STATUS_ADS']=='1'){  
      ...
      /////////// End type_train_station ////////////////
        ...
        ////////////// ผู้สร้าง  ////////////////////////////
             ...
             $ex_list_contacts=$rs_register['register_name'];
         ...
         if($ex_list_bargain!=''){
          //////////////  ผู้ติดต่อ  ////////////////////////////
             ...
             $ex_list_bargain=$rs_register['register_name'];    
 ...
 $objPHPExcel->getActiveSheet()->setCellValue('AD'.$no2,$sum_wa_all);
 ...
 $objPHPExcel->getActiveSheet()->setCellValue('AI'.$no2,$ex_list_img_score_name);
 $objPHPExcel->getActiveSheet()->setCellValue('AJ'.$no2,$ex_list_contacts);
 $objPHPExcel->getActiveSheet()->setCellValue('AK'.$no2,$ex_list_bargain);
 $objPHPExcel->getActiveSheet()->setCellValue('AL'.$no2,$ex_list_pm_status);
 $objPHPExcel->getActiveSheet()->setCellValue('AM'.$no2,$ex_list_remark);
 $objPHPExcel->getActiveSheet()->setCellValue('AN'.$no2,$ex_list_rent_till_note);



               unset($ex_list_project,$address,$ex_list_googlmap,$ex_list_train_station,$ex_list_total_floors_th,$ex_list_floor,$ex_list_sqm_th,$ex_list_bedroom_th,$ex_list_bathroom_th,$ex_list_parking ,$ex_list_total_floors_en , $ex_list_floor, $ex_list_sqm_en , $ex_list_bedroom_en , $ex_list_bathroom_en , $ex_list_other_room , $ex_list_direction , $ex_list_heading , $ex_list_sqm , $ex_list_heading_en , $detail_en , $ex_list_zone , $ex_list_img_score_name , $ex_list_contacts , $ex_list_bargain , $ex_list_pm_status , $ex_list_pm_status , $ex_list_remark , $ex_list_rent_till_note);
...
$objWriter->save(str_replace('.php', '.xls', "ddproperty_".$date_start."-".$date_end.".xls"));

// Echo done
//print "อ้างอิงจาก https://github.com/PHPOffice/PHPExcel";
print '<script>';
print 'window.open("ddproperty_".$date_start."-".$date_end.".xls");';
print '</script>';
...
// echo("<script> top.location.href='../../backend/report/download_file_excel_img.php?date_start=$date_start&date_end=$date_end'</script>");
}
?>