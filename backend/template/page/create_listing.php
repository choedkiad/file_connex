    ...
    ?> 
	                    <option value="<?php echo $rs_type['project_id'];?>"><?php echo $rs_type['project_name'];?></option> 
	<?php    }
	      }     ?>
	                  </select>
	                 </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9"> 
	                  <select class="form-control select2bs4"  name="ex_list_province" style="width: 100%;">
	                    ...
	                    <option value="0">ไม่เลือก</option> 
    <?php  
		 $sql_province="SELECT * FROM sys_province order by id  ASC"; 
    ...
    ?> 
	                    ...
	                    <option value="<?php echo $rs_province['code'];?>"><?php echo $rs_province['name_th'];?></option> 
	...
	<?php    }
              ...
              <div class="col-md-6"> 
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9"> 
	                  <select class="form-control select2bs4"  name="ex_list_status" style="width: 100%;"> 
	                    <option value="0">ยังไม่ขาย</option>  
	                    <option value="1">ขาย/เช่าไปแล้ว</option> 
                        <option value="2">ลูกค้าไม่ต้องการฝากขาย</option>  
	                  </select>
              ...
              <div class="col-md-6"> 
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputEmail3" name="ex_list_remark" placeholder="" value="" >
                    </div> 
                  </div>  
              </div>
