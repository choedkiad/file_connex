...
<?php     
  ...
  // if($ex_list_double_no!='4'){  // เช็คว่าเคย เช็คซ้ำไปรึยัง 
...
<?php
 ...
 /*
     ...
     $result_data_check=$conn->query($sql_data_check);   */
                    ...
                    $check_list_listing_type=$ex_list_listing_type;
                    $check_list_listing_name=$ex_list_listing_name;
                    $check_list_listing_name_en=$ex_list_listing_name_en;
                 ...
                 if($check_list_listing_type=='2' or $check_list_listing_type=='4' or $check_list_listing_type=='5' or $check_list_listing_type=='6'){ 
                      
                      $floor=$ex_list_total_floors;

                 } 



              if($check_list_listing_type=='1'){  // เฉพาะ คอนโด
                 ...
                 if($check_n_r!=''){
                    ...
                    $number_r_2=substr($check_list_house_number,$check_n_r+1 ,15 );
                 	...
                 	$number_r_2=$check_list_house_number;
                 }
                    ...
                    $number_r_2 = str_replace(" ","",$check_list_house_number,$count); 
      ...
      /////////// type_project ////////////////
             ...
             if($project_id!=''){ 
               ...
               $ex_list_project=$check_list_listing_name." | ".$check_list_listing_name_en;
...
<?php
                ...
                //L3
                 ...
                 if($ex_list_listing_type=='2' or $ex_list_listing_type=='4' or $ex_list_listing_type=='5' or $ex_list_listing_type=='6'){
...
/*
    ...
    if($_SESSION['STATUS_ID']=='2' or $_SESSION['STATUS_ID']=='3' or $_SESSION['STATUS_ID']=='4' 
      ...
      ////////// End type_asset ////////////////
                    ...
                    if($ex_list_listing_type=='1'){  // เฉพาะ คอนโด
                        ...
                        if($ex_list_house_number!=''){ 
                           ...
                           if($house_number_n_r!=''){
                                 $house_number_r_2=substr($ex_list_house_number,0 , $house_number_n_r);
                                 ...
                                 $house_number_r_2 = str_replace(" ","",$ex_list_house_number,$count);  
                        }
                        ...
                        $ex_list_sqm=$rs_listing['ex_list_sqm'];
/*
                    echo $rs_listing['ex_list_listing_code']." | ".$house_number_r_2." - ".$number_r_2." | TEL ".$check_list_contact_tel."-".$ex_list_contact_tel." | ".$floor."-".$ex_list_floor ."<br>";
*/
/*
                   $check_list_contact_tel=substr($check_list_contact_tel,-6,6); 
                   $ex_list_contact_tel1_2=substr($ex_list_contact_tel1_2,-6,6); 


                   $ex_list_contact_tel=substr($ex_list_contact_tel,-6,6); 
                   $ex_list_contact_tel1_2=substr($ex_list_contact_tel1_2,-6,6); 
             ...
             <?php } else if($floor==$ex_list_floor and $ex_list_sqm>$per_2 and  $ex_list_sqm<$per_1 and 
                             ...
                             or $floor==$ex_list_floor and $ex_list_sqm>$per_2 and  $ex_list_sqm<$per_1 and 
                                $check_list_contact_tel2_4==$ex_list_contact_tel2_4 and $check_list_contact_tel2_4!='' 
                                 ...
                                 if($floor==$ex_list_floor and $ex_list_sqm>$per_2 and  $ex_list_sqm<$per_1){   $double_no='2';  
                                ...
                                ?>
                                      <tr data-widget="expandable-table" aria-expanded="false" style="font-size: 12px;">                  
                                          ...
                                          <td > <center style="width: 180px; " ><a title="<?php echo $ex_list_contact_name;?>"><?php echo "".$ex_list_project;?></a></center></td> 
                                          <td><center style="width: 50px; " ><?php echo $ex_list_house_number;?></center></td>
                                          <td><?php echo $ex_list_bedroom_c;?></td>
                                          <td><?php echo $ex_list_floor;?></td>
                                          <td><?php echo $ex_list_sqm;?></td>     
                                          <td><a onclick="window.open('page/listing_prices.php?id=<?php echo $ex_list_listing_code;?>', '_blank', 'location=yes,height=570,width=520,scrollbars=yes,status=yes');">
                                            <?php echo $ex_list_price;?></a></td>   
...
<?php 
                                 }else if($house_number_r_2!=$number_r_2 and  $check_list_house_number!='' and $check_list_house_number!='-' and  $check_list_house_number!='_'){   $double_no='4';  
                            ...
                            <div class="row">
                              <div class="col-lg-12">
                                        ...
                                        <div class="modal-content bg-warning ">
                                          ...
                                          <div class="modal-body">
                                            <p>   การเพิ่มข้อมูลมีโอกาสซ้ำกับข้อมูลเดิม  <br>
                                              ทางระบบจะย้ายข้อมูลไปอยู่ แถบ "ตรวจสอบ Listing ซ้ำ" เพื่อรอการอนุมัติต่อไป
                                             </p>
                                          </div>
