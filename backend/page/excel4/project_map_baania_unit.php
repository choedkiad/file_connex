...
//echo "Connected successfully";
    ...
    require_once "PHPExcel.php";//เรียกใช้ library สำหรับอ่านไฟล์ excel
        $tmpfname = "project_map_baania_unit.xlsx";//กำหนดให้อ่านข้อมูลจากไฟล์จากไฟล์ชื่อ
       ...
       {   
        ...
        $project_unit=$worksheet->getCell('B'.$row)->getValue();// ชื่อProject Connex 
        $project_completed=$worksheet->getCell('C'.$row)->getValue();// ชื่อProject Connex          
             ...
             $sql = "UPDATE type_project SET   
              ...
              if ($conn->query($sql) === TRUE) {   
                           ...
                           echo $project_completed."-".$project_unit."<br>";
