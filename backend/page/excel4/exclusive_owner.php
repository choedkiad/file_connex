...
//echo "Connected successfully";
    ...
    require_once "PHPExcel.php";//เรียกใช้ library สำหรับอ่านไฟล์ excel
        $tmpfname = "exclusive_owner_all.xlsx";//กำหนดให้อ่านข้อมูลจากไฟล์จากไฟล์ชื่อ
       ...
       //นับว่า sheet แรกมีทั้งหมดกี่แถวแล้วเก็บจำนวนแถวไว้ในตัวแปรชื่อ $lastRow
        ...
        $tel=$worksheet->getCell('A'.$row)->getValue();
  
 
                $strSQL = "INSERT INTO dbo_contact_owner ";
                $strSQL .="(ex_owner_id  , ex_owner_name , ex_owner_create ) ";
                $strSQL .="VALUES ";
                      $strSQL .="('','".$tel."','".$todate."' )";   
                $conn->query($strSQL);  
