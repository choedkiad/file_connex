...
//echo "Connected successfully";
    ...
    require_once "PHPExcel.php";//เรียกใช้ library สำหรับอ่านไฟล์ excel
        $tmpfname = "listing_new25660730.xlsx";//กำหนดให้อ่านข้อมูลจากไฟล์จากไฟล์ชื่อ
...
<?php
     ...
     $no=0;  $no1=0;  $cx=0;
           ...
           if($result_data_check->num_rows > 0) {    // PAGE05

                while($rs_listing=$result_data_check->fetch_assoc()){ $no++;   $cx++;  // PAGE04 
         ...
         if($ex_list_listing_status=='' or $ex_list_listing_status=='0'){ $ex_list_listing_status="No Status"; $stauts_list_color="#000";  }
                    ...
                    if($house_number_r_2==$number_r_2 and  $number_room!=''and  $number_room!='-' and  $number_room!='_'){    // PAGE03  
                   ...
                   <?php }else if($floor==$ex_list_floor){    $no_2++;  // PAGE02  ?>

                      
                          <?php if($price!='' and $ex_list_deal_type=='1'){ $deal_text='ขาย';  // PAGE01 ?>
                           ...
                           <?php }  // PAGE01
                                ...
                                if($rent!='' and $ex_list_deal_type=='2'){ $deal_text='เช่า';  // PAGE01 ?>
             ...
             <?php  }else if($floor==$ex_list_floor and $ex_list_sqm>$per_2 and  $ex_list_sqm<$per_1 and $number1==$ex_list_contact_tel and $number1!='' 
                            ...
                            if($ex_list_bedroom==$bed) {  $no_2++;     // PAGE02
                              ...
                              ?>
                                      ...
                                      <?php if($price!='' and $ex_list_deal_type=='1'){ $deal_text='ขาย';  // PAGE00 ?>
                                      ...
                                      <?php }  // PAGE00 
                                           ...
                                           if($rent!='' and $ex_list_deal_type=='2'){ $deal_text='เช่า';  // PAGE00 ?>
                      ...
                      <?php     }else{  // PAGE01 ?>
                                      ...
                                      <?php } if($rent!='' and $ex_list_deal_type=='2'){ $deal_text='เช่า'; // PAGE00 ?>
