 ...
 <meta http-equiv="refresh" content="5;url=https://connex.in.th/backend/excel4/set_up_nameimg_listing.php"/> 
 <?php
...
//echo "Connected successfully";
     ...
     $sql= "SELECT ex_list_listing_code FROM dbo_data_excel_listing where 
                check_point!='999' and ex_list_img_number!='0' and ex_list_close='0' 
                order by ex_list_listing_code DESC  LIMIT 20 "; 
        ...
        // output data of each row
         while($rs=$result->fetch_assoc()) {  
              ...
              $rs_list_img=$result_list_img->fetch_assoc(); 
                ...
                echo  " CX : ".$ex_list_listing_code." img_folder : ".$folder_webp." img_name : ".$listing_img_name_1." webp: ".$listing_img_webp."<br>";                  
