 ...
 <meta http-equiv="refresh" content="10;url=https://connex.in.th/backend/excel4/up_log_listing2.php"/> 
 <?php
...
//echo "Connected successfully";
     ...
     $sql= "SELECT * FROM dbo_data_excel_listing where check_point!='7777'  and ex_list_close='0' order by ex_list_date_update DESC  LIMIT 50  "; 
