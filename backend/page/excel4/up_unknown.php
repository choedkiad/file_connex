...
//echo "Connected successfully";
    ...
    require_once "PHPExcel.php";//เรียกใช้ library สำหรับอ่านไฟล์ excel
        $tmpfname = "file_unknown2.xlsx";//กำหนดให้อ่านข้อมูลจากไฟล์จากไฟล์ชื่อ
       ...
       {   
        ...
        $code=$worksheet->getCell('A'.$row)->getValue(); //ประเภท
        $ex_list_listing_status=$worksheet->getCell('J'.$row)->getValue();// ชื่อ Zone ID
            ...
            echo $code." - ".$ex_list_listing_status."<br>"; 
