      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">ประวัติการเพิ่ม-ลบภาพประกอบ <?php echo $id;?></h3>
          ...
          <?php
                 ...
                 $sql_record="SELECT * FROM dbo_record where ex_list_id='$id' and record_note LIKE '%ลบภาพ%' or  
                              ex_list_id='$id' and record_note LIKE '%เพิ่มภาพประกอบ%'  
                ...
                // output data of each row
                 while($rs_record=$result_record->fetch_assoc()){
                  ...
                  $record_note=$rs_record['record_note'];
                  $record_user_id=$rs_record['record_user_id']; 
                  $record_remark=$rs_record['record_remark'];

                  if($record_note=='ลบภาพ'){ 
                           $record_note="ลบภาพ";  
                  }else{
                           $record_note="เพิ่มภาพ";                  
                  }
 
                  if($record_remark==''){ $record_remark='ไม่ระบุจำนวน';}
