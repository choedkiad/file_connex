   ...
   if( $_SESSION['STATUS_ID']=='1'){  
       ...
       echo("<script> top.location.href='?page=upload_file_excel_check'</script>");   
        ...
        if($status=='create'){
           ...
           $sql_p="SELECT * FROM type_project order by project_id DESC ";
           $result_p= $conn->query($sql_p);  
           $rs_p=$result_p->fetch_assoc();

            $project_ids=$rs_p['project_id']; 
            $project_id=$project_ids+1;
            $code = sprintf("p%'05d",$project_id);


             $sql="INSERT INTO type_project( project_id , register_id_create , search_p_id , project_create)
              VALUES ( '' ,'$USER_ID' , '$code'  , '$todate' )";
             $conn->query($sql); 
           ...
           echo("<script> top.location.href='?page=create_project&status=edit&id=$project_id'</script>"); 
        ...
        // output data of each row
         ...
         $project_pet_friendly=$rs_project['project_pet_friendly']; 
         $project_pet_friendly_type=$rs_project['project_pet_friendly_type']; 
         ...
         $project_propertyhub_id=$rs_project['project_propertyhub_id'];
         $project_propertyhub_name=$rs_project['project_propertyhub_name'];
             ...
             <div class="col-md-4 col-sm-12"> 
                          <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-12"> 
                                <select class="form-control"  name="project_pet_friendly" id="project_pet_friendly" style="width: 100%;"> 
                                  <option value="0" <?php if($project_pet_friendly=='0'){ ?>selected <?php } ?> >ไม่เลี้ยง  </option>  
                                  <option value="1" <?php if($project_pet_friendly=='1'){ ?>selected <?php } ?>>เลี้ยงสัตว์ </option>                      
                                </select>

                            </div>
                            <div class="col-md-6 col-sm-12"> 
                                 <input type="text" class="form-control" id="project_pet_friendly_type" name="project_pet_friendly_type" placeholder="โปรดกรอกประเภทสัตว์เลี้ยง"   value="<?php echo $project_pet_friendly_type;?>" >
                            </div>
                          </div> 
                      </div>
...
?> 
   ...
   <!-- /.col -->
       ...
       <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Property Hub (ส่วนนี้เจ้าหน้าที่ Admin กรอกให้เอง)</h3>
          ...
          <div class="card-body">
            <div class="row"> 
              <div class="col-md-6"> 
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-4 col-form-label">PROJECT ID : </label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="project_propertyhub_id" name="project_propertyhub_id" placeholder="" value="<?php echo $project_propertyhub_id;?>"    >
                    </div>
                  </div> 
              </div>
                <div class="col-md-6"> 
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-4 col-form-label">ชื่อโครงการภาษาอังกฤษ : </label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="project_propertyhub_name" name="project_propertyhub_name" placeholder="" value="<?php echo $project_propertyhub_name;?>"    >
                    </div>
                  </div> 
              </div>
          ...
          <div class="card-body">
            <div class="row">
               ...
               <div class="col-md-3" style="padding: 10px;">  
                ...
                <a class="btn btn-block bg-gradient-danger" onclick="window.open('page/upload_images_create_project.php?id=<?php echo $id;?>', '_blank', 'location=yes,height=570,width=800,scrollbars=yes,status=yes');">อัพโหลดไฟล์ภาพ </a>
               </div>
               <div class="col-md-3" style="padding: 10px;">  
...
<!--
   ...
   <!-- /.col -->
    ...
    <?php  
     ...
     ?>  
               <div class="col-md-3" style="padding: 10px;"> 
                  <center><a href="include/process.php?page=create_project_img&status=del_img&id=<?php echo $id;?>&img=<?php echo $project_img_name;;?>"> 
                    <img src="img/icon/png/trash-2x.png" ></a>
