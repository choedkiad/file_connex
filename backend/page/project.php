...
*/
   ...
   if($station!=''){ 
          $s_station=" and project.project_train_station='$station'  ";  
...
if($_GET['page_no']==''){
   echo("<script> top.location.href='?page=project&p=$p&page_no=1'</script>");   
}
              ...
              <!-- form start -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-2" style="padding: 10px;">
                         <a href="?page=create_project&status=create" class="btn btn-block btn-primary btn-lg" > เพิ่มโครงการ</a>
                    </div>
                </div>
            <div class="card">
      ...
      <?php }
                  ...
                  <div class="col-md-12"  ><br>
                     <center><button type="submit" class="btn btn-primary">Search Data</button> &nbsp;&nbsp;&nbsp;
                          <a class="btn btn-primary" href="?page=project&p=<?php echo $p;?>">Clear Data</a>
                     </center>
...
if($p=='delete'){
   ...
   $calExpireDate=date ("Y-m-d", strtotime("+15 day", strtotime($today)));
    ...
    if($p==''){ 
          ...
          $number_desc=" project.project_id  DESC "; 
...
// echo $search_all_s;
        // output data of each row
         ...
         $project_img_name=$rs_project['project_img_name'];
         $project_img_webp=$rs_project['project_img_webp'];
         ...
         $project_create=$rs_project['project_create'];
  ...
  $year=substr($project_create,0 , 4 );
  $month=substr($project_create,5 , 2 );
  $day=substr($project_create,8 , 2 );

  $time=substr($project_create,11 , 5 );
  $year=$year+543;
 ...
 $expire_check="";
      ...
      /////////// type_train_station ////////////////
          ...
          if($station_id!=''  ){    
             $sql_train="SELECT station_train ,station_name_en  FROM type_train_station where station_id='$project_train_station' ";  
     ...
     ?> 
           ...
           <?php } ?>
                    <td> 
                        <center style="width: 70px; " ><a target="_blank" href="#" title=" "  > <?php echo $project_id;?> </a> </center>
                    ...
                    <td><center style="width: 50px; " ><?php echo $project_listing_count;?></center></td> 
                    <td><center style="width: 50px; " ><?php if($project_img_webp!=''){ ?> <img src="https://connex.in.th/images/project/<?php echo $project_id;?>/webp/mini_w500/<?php echo $project_img_webp;?>" style="width: 50px;" > <?php } ?>  </center></td>  
