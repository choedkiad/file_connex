        ...
        $rent = str_replace(",","",$rent,$count);  
            ...
            <?php
             ...
             $name_cx="CX-".$cx;
                       ...
                       $sql_2="INSERT INTO dbo_data_excel_listing (ex_list_id  , ex_list_listing_code, ex_list_listing_type , ex_list_deal_type, project_id, ex_list_contract_type , ex_list_room_id , ex_list_furniture_id , ex_list_bedroom , ex_list_bathroom ,ex_list_sqm , ex_list_price , ex_list_contact_name , ex_list_contact_tel , ex_list_contact_tel1_2, ex_list_contact_tel1_3 , ex_list_contact_tel1_4 , ex_list_house_number , ex_list_floor , ex_list_date_create , check_point , ex_list_contact )
                          VALUES ('', '$name_cx' , '1' , '2', '$project_id' , '3'  , '$type' , '$furnished' ,'$bed' ,'$bath' ,'$size' ,'$rent' ,'$ex_list_contact_name' ,'$number1' ,'$number2' ,'$number3' ,'$number4' , '$number_room' , '$floor' , '$todate' , '25660803' , '97')";
