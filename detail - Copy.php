     ...
     if($ex_list_listing_type!='1'){
      ...
      ////////// End type_asset ////////////////
         ...
         while($rs_img=$result_img->fetch_assoc()){  $img_pro++;
            ...
            if($img_pro=='1'){
                 if($project_img_id!=''){ $project_img_folder1="../../images/project/$project_id/webp/".$project_img_webp;  
            ...
            if($img_pro=='2'){
                 if($project_img_id!=''){ $project_img_folder2="../../images/project/$project_id/webp/".$project_img_webp; }
                 else{ $project_img_folder2=$project_img_folder1;  }
            }
            if($img_pro=='3'){
                 if($project_img_id!=''){ $project_img_folder3="../../images/project/$project_id/webp/".$project_img_webp; }
                 else{ $project_img_folder3=$project_img_folder1;  }
            }
            if($img_pro=='4'){
                 if($project_img_id!=''){ $project_img_folder4="../../images/project/$project_id/webp/".$project_img_webp; }
	...
	<main>
       ...
       <?php } ?>
                  <header class="w3-container w3-teal"> 
                    ...
                    <p class="w3-teal-head"><?php echo $share_link_title;?></p>
                  </header>
      ...
      <?php } ?>
                  ...
                  <div><img src="../../../images/location_map.webp" alt="<?php echo $location_map_title;?>" title="<?php echo $location_map_title;?>" ></div> 
                   ...
                   <img src="<?php echo $img_list2;?>" class="img_r1" data-num="2" alt="<?php echo $settings_title;?>" title="<?php echo $settings_title;?>"  >
              </div>
							<div style="cursor: pointer;" >
                   <img src="<?php echo $img_list3;?>"  data-num="3" alt="<?php echo $settings_title;?>" title="<?php echo $settings_title;?>" >
              </div>
							<div style="cursor: pointer;" >
                   <img src="<?php echo $img_list4;?>" class="img_r2"  data-num="4" alt="<?php echo $settings_title;?>" title="<?php echo $settings_title;?>" >
    ...
    <?php } ?>
      ...
      <?php } ?>
                ...
                <input type="text" class="form-control-textbox" id="name" hidden  value="<?php echo $heading_h1;?>" name="contact_heading" >
                  ...
                  <center>
                      <div class="g-recaptcha" data-callback="makeaction"  data-sitekey="6LfQtnglAAAAAPWamZXtjcYnsHfZRmwDKVRtcn-r" style="font-family: SukhumvitSet-Text; margin-bottom: 10px;"></div>
                  </center>
                      ...
                      <div class="information2">
                        ...
                        <input type="text" class="form-control-textbox" id="name" hidden  value="<?php echo $heading_h1;?>" name="contact_heading" >
                         ...
                         <script> // กำหนดปุ่มเป็น disable ไว้ ต้องทำ reCHAPTCHA ก่อนจึงกดได้
                          ...
                          <center>
                              <div class="g-recaptcha" data-callback="makeaction"  data-sitekey="6LfQtnglAAAAAPWamZXtjcYnsHfZRmwDKVRtcn-r" style="  font-family: SukhumvitSet-Medium;margin-bottom: 20px;"></div>
                          </center>  
          ...
          if($ex_list_listing_type=='1' or $ex_list_total_floors=='' or $ex_list_total_floors=='0'){
            ...
            $ex_list_total_floors_en=$project_total_floors.""; 
             ...
             if($project_img_webp!=''){ 
                 ...
                 $project_img_folder="../../images/project/$project_id/webp/".$project_img_webp; 
                  ...
                  $project_img_folder="../../images/noimages.webp"; 
                     ...
                     if($listing_img_folder!=''){   
                           ...
                           $img_name_list=$listing_img_folder."".$project_img_webp;
                           $img_name_list=str_replace(" ","%20",$img_name_list);

                     }else if($project_img_webp!=''){   
...
<?php } ?>   
 ...
 <?php include("./include/footer.php"); ?>
	...
	<div class="modal fade" id="viewImg" style="z-index: 100002;">
...
<?php 
    ...
    if($ex_list_img_number!='0'){
             ...
             while($rs_img=$result_img->fetch_assoc()){  $img_no++;
                                    ...
                                    $image_name=$rs_img['listing_img_webp']; 
                                      ...
                                      if($img_folder!=''){ 
                                               ...
                                               $img_folder='../../../../images/listing/'.$id.'/webp/'.$image_name; $img_folders="";
          ...
          ?>
									...
									<div class="carousel-item <?php if($img_no=='1'){ ?>active <?php } ?>" id="1">
										<img src="<?php echo $img_folder;?>" alt="<?php echo $settings_title;?>" title="<?php echo $settings_title;?>" class="img-fluid d-block mx-auto">
...
<?php        
         ...
         $sql_img="SELECT * FROM type_project_img where project_id='$project_id_check' order by project_img_no ASC LIMIT 1"; 
         $result_img=$conn->query($sql_img); 
         while($rs_img=$result_img->fetch_assoc()){  $img_no++;
             ...
             if($project_img_id!=''){ $project_img_folder="../../images/project/$project_id_check/webp/mini_w100/".$project_img_webp; }else{ $project_img_folder="../../images/project/$project_id_check/webp/mini_w100/" ;  }

 ?>


                  <div class="carousel-item <?php if($img_no=='1'){ ?>active <?php } ?>" id="1">
                    <img src="<?php echo $project_img_folder;?>" alt="<?php echo $settings_title;?>" title="<?php echo $settings_title;?>" class="img-fluid d-block mx-auto">
        ...
        <script src="https://polyfill.io/v3/polyfill.min.js?features=default"></script>
                  ...
                  <script>
                      ...
                      var marker = new google.maps.Marker({
                         ...
                         map: maps,
                         title: '<?php echo $project_name_en_check;?>',
                         icon: '../../../images/pin_map.webp',
                      });
                      

                      var info = new google.maps.InfoWindow({
                        content : '<div style="font-size: 25px;color: red"><?php echo $project_name_en_check." ";?></div>'
                      });
...
<script type="text/javascript">
  ...
  <script>
    ...
    $(document).ready(function() {  
      ...
      $('.prevxx').click(function(){    
        var itemx = $('.carouselx .carousel-indicators li').length;       
        var nex_v = $(".carousel-indicators li.active").index(".carousel-indicators li");     
        var end_li = (Number(itemx)-6);     
        var itemxspan = $(".carousel-indicators li.active").index(".carousel-indicators li");     
        ...
        if(nex_v==0){    
          $(".carousel-indicators li").css("display","none");  
          $(".carousel-indicators li:nth-child(n+"+end_li+"):nth-child(-n+"+itemx+")").css("display","block"); 
          $(".carousel-indicators li:nth-child(9)").addClass("active"); 
          $('.item-span').text(itemx);    
          $(".nextx input").val(end_li);
          $(".prevx input").val(end_li);  
        }  

      });
      $('.nextxx').click(function(){   
        var itemx = $('.carouselx .carousel-indicators li').length;       
        var nex_v = $(".carousel-indicators li.active").index(".carousel-indicators li");   
        var itemxspan = Number($(".carousel-indicators li.active").attr("data-slide-to")) + Number(2);    
        if(nex_v<itemx-7){   
          $.nextTum();
        }    
        $('.item-span').text(itemxspan);     
        if(itemxspan==itemx+1){    
          $(".carousel-indicators li").css("display","none");  
          $(".carousel-indicators li:nth-child(n+1):nth-child(-n+7)").css("display","block"); 
    ...
    //  var startx = 1;
    //  var itemx = $('.carouselx .carousel-indicators li').length;  
    //  var start_li = Number($(".nextx input").val()) - Number(startx);
    //  var end_li = Number($(".nextx input").val()) + (Number(showx)-2);   
    //  $(".nextx input").val(start_li);    
    //  $(".prevx input").val(start_li);    
    //  var counts = (itemx-showx);  
    //  if($(".prevx input").val()==1){
    //    $(".prevx").css("display","none"); 
    //  }    
    //  if($(".prevx input").val()==counts){
    //    $(".nextx").css("display","block"); 
    //  }     
    //  $(".carousel-indicators li").css("display","none");  
    //  $(".carousel-indicators li:nth-child(n+"+start_li+"):nth-child(-n+"+end_li+")").css("display","block"); 
    // });
    $.nextTum = (function() {    
      var showx = 7; 
      var startx = 1;
      var itemx = $('.carouselx .carousel-indicators li').length;  
      var start_li = Number($(".nextx input").val()) + Number(startx);
      var end_li = Number($(".nextx input").val()) + Number(showx);   
      $(".nextx input").val(start_li);    
      $(".prevx input").val(start_li); 
      var counts = (itemx-showx); 
      if($(".nextx input").val()>counts){
        $(".nextx").css("display","none");
      }   
      if($(".nextx input").val()>1){
        $(".prevx").css("display","block");
      }   
      $(".carousel-indicators li").css("display","none");  
      $(".carousel-indicators li:nth-child(n+"+start_li+"):nth-child(-n+"+end_li+")").css("display","block"); 
    });

    $(".nextx").click(function (event) { 
      var showx = 7; 
      var startx = 1;
      var itemx = $('.carouselx .carousel-indicators li').length;  
      var start_li = Number($(".nextx input").val()) + Number(startx);
    ...
    $(document).ready(function() { 
      ...
      $(".carousel-indicators li:nth-child(n+1):nth-child(-n+7)").css("display","block");   
      $(".prevx").css("display","none");    
      $('.count-item').text($('.carouselx .carousel-indicators li').length);
      $('.item-span').text(1); 
    });

    $(".carousel-indicators li").click(function (event) { 
    var itemxspan = Number($(this).attr("data-slide-to")) + Number(1);    
    $('.item-span').text(itemxspan);   
    });
    ...
    $("#range").on('input change', function (event) {
      ...
      $("#demo .carousel-inner .carousel-item img").css("transform", "scale("+$(event.currentTarget).val()+")"); 
    ...
    $("#compress-alt").click(function (event) {
      $('#range').val(1);
      $("#demo .carousel-inner .carousel-item img").css("transform", "scale(1)"); 
      $(".range-img #compress-alt").removeClass("active"); 
    });
    ...
    $('.img-view').click(function() {     
      ...
      $("#demo .carousel-indicators li").removeClass("active");
      $("#demo .carousel-indicators li:nth-child("+1+")").addClass("active");

      $("#demo .carousel-inner .carousel-item").removeClass("active");
      $("#demo .carousel-inner .carousel-item:nth-child("+1+")").addClass("active");  
    ...
    $('.img-view-sub div').click(function() {    
      ...
      $("#demo .carousel-indicators li").removeClass("active");
      $("#demo .carousel-indicators li:nth-child("+$(this).attr('data-num')+")").addClass("active");

      $("#demo .carousel-inner .carousel-item").removeClass("active");
      $("#demo .carousel-inner .carousel-item:nth-child("+$(this).attr('data-num')+")").addClass("active"); 
 
      $('.item-span').text($(this).attr("data-num"));   
    });
    ...
    $(document).scroll(function() {
      ...
      else if ( $(document).scrollTop() >= 900 && $(document).scrollTop() <= 1800 ) {
    ...
    $('.all-viewx .col-4 img').click(function() { 
      ...
      $("#demo .carousel-indicators li").removeClass("active");
      $("#demo .carousel-indicators li:nth-child("+$(this).attr('id')+")").addClass("active");
      
      $("#demo .carousel-inner img").removeClass("active");
      $("#demo .carousel-inner img:nth-child("+$(this).attr('id')+")").addClass("active");
