            ...
            <div class="container">   
              ...
              <?php $i=0;
                 ...
                 ?>  
                                            ...
                                            <li style=" <?php echo $height_s;?> " data-thumb="<?php echo $img_name_w100;?>"  > 
                                ...
                                <div class="dealer-content">
                                    <div class="inner-wrapper">
                                        <div class="single-property-header">                                          
                                            <h1 class="property-title"><?php echo $ex_list_project_en;?></h1>
                                        ...
                                        <div class="clear"  >
                                            ...
                                            <div class="col-xs-8 col-sm-8 ">
                                                <h3 class="dealer-name" style="text-align: left;">
                                                    ...
                                                    <img src="../../images/icon/icon_mobile.png" width="30" alt="เบอร์โทรศัพท์"><a href="tel:<?php echo $register_line;?>"> <?php echo $register_tel;?></a><br>
                                                    <b><img src="../../images/icon/icon_line.png" width="30" alt="เบอร์โทรศัพท์"> </b><a href="tel:<?php echo $register_line;?>"><?php echo  $register_line;?></a>   
                                                </h3>
