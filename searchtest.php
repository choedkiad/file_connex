...
/*
 ...
 /*
     echo("<script> top.location.href='<?php echo BASE_URL;?>/searchtest/$lang/$deal_s/$type_s/$project_s/$size_s/$price_s/$room_s/$search_s/1'</script>");  */
 
    $baseUrl = BASE_URL;  
    $part="../../../../../../../../../../../../";
    $myurl= $baseUrl."/searchtest/".$lang."/".$deal_s."/".$type_s."/".$project_s."/".$size_s."/".$price_s."/".$room_s."/".$search_s."/";

    $myurl_check= $baseUrl."/searchtest/".$lang."/".$deal_s."/".$type_s."/".$project_s."/".$size_s."/".$price_s."/".$room_s."/".$search_s."/".$page_no;
 ...
 //////////////////// พื้นที่-พื้นที่ใช้สอย //////////////////////
        ...
        if($type_s=="1" or $type_s=="all" ){
          ...
          if($size_min!='' and $size_max==''){ 
              ...
              if($type_s=="1" or $type_s=="all" ){
                  $size_title_h=$size_title;   
              }else{
                  $size_title_h=$area_land_title;
              }    
          }
...
///////////////////////////////////////////// SEO ///////////////////////////////////////////////////
   ...
   if($lang=='th'){
      ...
      $url_th= $baseUrl."/searchtest/th/".$deal_s."/".$type_s."/".$project_s."/".$size_s."/".$price_s."/".$room_s."/".$search_s."/".$page_no;
      $url_en= $baseUrl."/searchtest/en/".$deal_s."/".$type_s."/".$project_s."/".$size_s."/".$price_s."/".$room_s."/".$url_project_name."/".$page_no;

   }else{

      $url_th= $baseUrl."/searchtest/th/".$deal_s."/".$type_s."/".$project_s."/".$size_s."/".$price_s."/".$room_s."/".$url_project_name."/".$page_no;
      $url_en= $baseUrl."/searchtest/en/".$deal_s."/".$type_s."/".$project_s."/".$size_s."/".$price_s."/".$room_s."/".$search_s."/".$page_no;
...
<?php 
 ...
 if($_GET['page_no']==''){
	echo("<script> top.location.href='../../../searchtest/$lang/$id/1'</script>");   
 }
                  ...
                  <tr>
                     <td style="width: 15%;">
                          ...
                          <div class="form-group">
                            <label ><?php echo $property_type_title;?></label>
                                <select  class="form-control" title="<?php echo $property_type_title;?>" name="type_s" id="type_s"  width="100%" onchange="if (this.options[selectedIndex].value != '') {document.location.href=this.options[selectedIndex].value}" > 
                                  <option value="<?php echo BASE_URL;?>/searchtest/<?php echo $lang;?>/<?php echo $deal_s;?>/all/<?php echo $project_s;?>/<?php echo $size_s;?>/<?php echo $price_s;?>/<?php echo $room_s;?>/<?php echo $search_s;?>/1"><?php echo $all_title;?></option> 
                        <?php 
                        ...
                        if($check_s=='p'){
                                ...
                                $url="searchtest/$lang/".$deal_s."/".$asset_id."/".$project_s."/".$size_s."/".$price_s."/".$room_s."/".$search_s."/1";
                          ...
                          <div class="form-group">
                            <label ><?php echo $deal_title;?></label>
                              <select class="form-control" title="<?php echo $deal_title;?>" data-show-subtext="true" data-live-search="true"  name="deal_s" id="deal_s" width="100%" onchange="if (this.options[selectedIndex].value != '') {document.location.href=this.options[selectedIndex].value}" > 
                                <option value="<?php echo BASE_URL;?>/searchtest/<?php echo $lang;?>/all/<?php echo $type_s;?>/<?php echo $project_s;?>/<?php echo $size_s;?>/<?php echo $price_s;?>/<?php echo $room_s;?>/<?php echo $search_s;?>/1"><?php echo $all_title;?></option> 
                                <option value="<?php echo BASE_URL;?>/searchtest/<?php echo $lang;?>/1/<?php echo $type_s;?>/<?php echo $project_s;?>/<?php echo $size_s;?>/<?php echo $price_s;?>/<?php echo $room_s;?>/<?php echo $search_s;?>/1" <?php if($deal_s=="1"){?> selected="selected" <?php } ?> ><?php echo $buy_title;?></option> 
                                <option value="<?php echo BASE_URL;?>/searchtest/<?php echo $lang;?>/2/<?php echo $type_s;?>/<?php echo $project_s;?>/<?php echo $size_s;?>/<?php echo $price_s;?>/<?php echo $room_s;?>/<?php echo $search_s;?>/1" <?php if($deal_s=="2"){?> selected="selected" <?php } ?> ><?php echo $rent_title;?></option> 
                              </select> 
                          </div> 
                        </div> 
                     </td> 
                          ...
                          <div class="form-group">
                            <label ><?php echo $room_title;?></label>
                              <select class="form-control" title="<?php echo $room_title;?>" data-show-subtext="true" data-live-search="true" name="room_s" id="room_s_checks_condo" width="100%" onchange="if (this.options[selectedIndex].value != '') {document.location.href=this.options[selectedIndex].value}" > 
                                <option value="<?php echo BASE_URL;?>/searchtest/<?php echo $lang;?>/<?php echo $deal_s;?>/<?php echo $type_s;?>/<?php echo $project_s;?>/<?php echo $size_s;?>/<?php echo $price_s;?>/all/<?php echo $search_s;?>/1" <?php if($room_s=="all"){ ?>selected="selected" <?php } ?>  ><?php echo $all_title;?></option> 
                                
                     <?php for($x=0; $x <= 10; $x++) { ?>
                                <option value="<?php echo BASE_URL;?>/searchtest/<?php echo $lang;?>/<?php echo $deal_s;?>/<?php echo $type_s;?>/<?php echo $project_s;?>/<?php echo $size_s;?>/<?php echo $price_s;?>/<?php echo $x;?>/<?php echo $search_s;?>/1" <?php if($room_s==$x and $room_s!='all'){ ?>selected="selected" <?php } ?> ><?php if($x==0){ echo "Studio"; }else{ echo $x." ".$bedroom_title; } ?>
                    ...
                    <?php  } ?>      
                     ...
                     <?php for($x = 1; $x <= 10; $x++) { ?>
                                <option value="<?php echo BASE_URL;?>/searchtest/<?php echo $lang;?>/<?php echo $deal_s;?>/<?php echo $type_s;?>/<?php echo $project_s;?>/<?php echo $size_s;?>/<?php echo $price_s;?>/<?php echo $x;?>/<?php echo $search_s;?>/1" <?php if($room_s==$x and $room_s!='all'){ ?>selected="selected" <?php } ?>><?php echo $x." ".$bedroom_title;?>
                                  ...
                                  <div id="myDropdown2" class="dropdown-content">
                                   <form  name="form2" action=""  enctype="multipart/form-data" method="post" >
                                       <div class="form-group row">
                                          ...
                                          <div class="col-lg-6">
                                            <label><?php echo $minimum_title;?></label>
                                            <input type="text" class="form-control" name="price_min" id="price_min2" placeholder="<?php echo $minimum_title;?>" value="<?php echo $price_min;?>" OnKeyPress="return chkNumber(this)"  >
                                          </div>
                                          <div class="col-lg-6">
                                            <label><?php echo $maximum_title;?></label>
                                            <input type="text" class="form-control" name="price_max" id="price_max2" placeholder="<?php echo $maximum_title;?>" value="<?php echo $price_max;?>" OnKeyPress="return chkNumber(this)"  >
                                          </div>
...
<!--
                     ...
                     <td style="width: 12%;">
                       <div class="form-group">
                          <label ><?php echo $sort_s_title_0;?></label>             
              ...
              <div class="search_m" > 
                      ...
                      <div class="form-group"> 
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6"  >
                                <!--<label><?php echo $minimum_title;?></label>-->
                                <input type="text" class="form-control" name="price_min" id="price_min" placeholder="<?php echo $minimum_title;?>" value="<?php echo $price_min;?>"  style="margin-right: 4px;" OnKeyPress="return chkNumber(this)" >
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                                 <!--<label><?php echo $maximum_title;?></label>-->
                                 <input type="text" class="form-control" name="price_max" id="price_max" placeholder="<?php echo $maximum_title;?>" value="<?php echo $price_max;?>" style="margin-left: 4px;" OnKeyPress="return chkNumber(this)"  >
                            </div>
                        </div>
                      </div>
...
$row_num_sum = $result->num_rows;
    ...
    ////////// End type_asset ////////////////
              ...
              if($project_id!='' and $project_id!='0'){
                     ...
                     // TEXT ปักหมุด GOOGLE MAP https://connex.in.th/searchtest/th/2/all/p00002/all/all/all/28-%E0%B8%8A%E0%B8%B4%E0%B8%94%E0%B8%A5%E0%B8%A1/1

      		    	          $project_name_text="Project : ".$project_name_en." &nbsp;&nbsp;&nbsp;"; 
                          $url_project=str_replace(" ","-",$project_name_en ,$count);  
      		                $project_name_text="<a href='$baseUrl/searchtest/en/$ex_list_deal_type/all/$search_p_id/all/all/all/$url_project/1' target='_blank' >$project_name_text</a>"; 
                     ...
                     // TEXT ปักหมุด GOOGLE MAP
                          ...
                          $url_project=str_replace(" ","-",$project_name_en ,$count);  
                          $project_name_text="<a href='$baseUrl/searchtest/en/all/all/$project_s/all/all/all/$url_project/1' target='_blank' >$project_name_text</a>"; 
