...
<?php   include ("./setting.php");
     ...
     $result_listing=$conn->query($sql_listing); 
      ...
      if($result_listing->num_rows > 0) {
         ...
         $ex_list_bathroom_check=$rs_listing['ex_list_bathroom'];
         ...
         $budget_s=$ex_list_price*30/100;
         $budget_start_s=$ex_list_price-$budget_s;
         $budget_end_s=$ex_list_price+$budget_s;
  ...
  // สำหรับที่ดินเท่านั้น
    ...
    $rs_furniture=$result_furniture->fetch_assoc();
       ...
       $furniture_name_en=$furniture_name_en; 
        ...
        if($project_id!='' and $project_id!='0'){
            ...
            if($ex_list_listing_type=='1' or $ex_list_total_floors=='' or $ex_list_total_floors=='0'){
             ...
             $project_province=$ex_list_province;
             $project_district=$ex_list_district;
             $project_subdistrict=$ex_list_subdistrict;
         }
      ...
      /////////// type_train_station ////////////////
             ...
             $station_name=$rs_train['station_name'];
             $station_name_en=$rs_train['station_name_en'];
             $tr_group=$rs_train['tr_group'];
             $search_s_id=$rs_train['search_s_id'];

             if($station_name!=''){ 

                      $ex_list_train_station=$tr_group."-".$station_name." | ".$station_name_en;  
                      $ex_list_train_station_th=$tr_group."-".$station_name;
                      $ex_list_train_station_en=$tr_group."-".$station_name_en;
                      $url_station_th=str_replace(" ","-",$station_name ,$count); 
                      $url_station_en=str_replace(" ","-",$station_name_en ,$count); 
     ...
     if($ex_list_listing_type!='1'){
      ...
      ////////// End type_asset ////////////////
           ...
           while($rs_img=$result_img->fetch_assoc()){  $img++;
                    ...
                    $img_folder=$baseUrl.'/images/listing/'.$id.'/webp/'.$image_name;

                    $url_img_listing[$img]=$img_folder;   
            }

         // Zoin_id //  
         $strSQL_zone= "SELECT search_z_id , zone_name ,zone_name_en  FROM type_zone where zone_id='$zone_id'  "; 
         $result_zone=$conn->query($strSQL_zone);  
         $rs_zone=$result_zone->fetch_assoc();
            ...
            if($lang=='th'){
            	  $zone_titles=$zone_name;
                  $url_name=str_replace(" ","-",$zone_name ,$count);                   
                  $url_name=strtolower($url_name); 
                  $url_zone=$baseUrl."/search/th/".$deal_s."/".$ex_list_listing_type."/".$search_z_id."/".$ex_list_bedroom."/".$url_name."/1";
            }else{
            	  $zone_titles=$zone_name_en;
                  $url_name=str_replace(" ","-",$zone_name_en ,$count);                   
                  $url_name=strtolower($url_name); 
                  $url_zone=$baseUrl."/search/en/".$deal_s."/".$ex_list_listing_type."/".$search_z_id."/".$ex_list_bedroom."/".$url_name."/1";            }

         $img_pro=0;

         $sql_img="SELECT *  FROM type_project_img where project_id='$project_id' order by project_img_no ASC"; 
         $result_img=$conn->query($sql_img); 
         while($rs_img=$result_img->fetch_assoc()){  $img++; $img_pro++;
             ...
             $project_img_folder1="../../images/project/$project_id/webp/".$project_img_webp; 
            
             $url_img_listing[$img]=$project_img_folder1; 
         
             if($img_pro=='1'){
                   $project_img_max300_folder1="../../images/project/$project_id/webp/mini_w500/".$project_img_webp; 
             }
 
         }
 

       if($project_img_max300_folder1==''){
            $project_img_max300_folder1="../../images/noimages.webp";
       }
      ...
      if($lang=='th'){
       ...
       if($ex_list_date_update=='0000-00-00 00:00:00'){
          ...
          $link_pro="$baseUrl/search/th/$ex_list_deal_type/$project_type/$search_p_id/all/$url_project_name_en/1";
          ...
          $link_station="$baseUrl/search/th/$ex_list_deal_type/all/$search_s_id/all/$url_station_th/1";
     ...
     if($ex_list_bedroom!='' and $ex_list_bedroom=='0'){     $ex_list_bedroom="สตูดิโอ";   }
        ...
        // <<The Capital Ekkamai – Thonglor>> is a <<Condo>> project located in <<Bangkapi, Huaykwang, Bangkok>>, <<close to MRT Huaykwang>>. It has <<329 units>> across <<8 floors>>. <<The building was completed in 2015>>
          ...
          if($project_id!='0'){
              ...
              $heading_h1=$ex_list_listing_name;
       ...
       if($ex_list_date_update=='0000-00-00 00:00:00'){
          ...
          $link_pro="$baseUrl/search/en/all/$project_type/$search_p_id/all/$url_project_name_en/1";
          $url_share=$url_en;
          $addres=$address_en; 
          ...
          $link_station="$baseUrl/search/en/all/all/$search_s_id/all/$url_station_en/1";
        ...
        /* 
          ...
          if($project_id!='0'){
                 ...
                 $heading_h1=$ex_list_listing_name_en;
...
<head>
  ...
  <meta charset="utf-8">
    ...
    <!-- Preload -->
    <link rel="preload" href="<?php echo $part;?>css/bootstrap.css?v=<?php echo $todate;?>" as="style" /> 
    <!--END Preload -->

    <!--<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css?v=<?php echo $todate;?>">-->
    <link rel="stylesheet" href="<?php echo $part;?>css/bootstrap.css?v=<?php echo $todate;?>" />
 <?php if($device=="pc"){ ?> 

    <!-- Preload -->
    <link rel="preload" href="<?php echo $part;?>css/main.css?v=<?php echo $todate;?>" as="style">
    <!--END Preload -->

    <link rel="stylesheet" href="<?php echo $part;?>css/main.css?v=<?php echo $todate;?>" />
<!--    <link rel="preload" onload="this.rel = 'stylesheet'" href="<?php echo $part;?>css/main.css?v=<?php echo $todate;?>" as="style">-->
 <?php }else{ ?> 
    <!-- Preload -->
    <link rel="preload" href="<?php echo $part;?>css/main_mobile.css?v=<?php echo $todate;?>" as="style" /> 
    <!--END Preload -->
 ...
 <?php } ?>
  ...
  <!-- 
    ...
    <!-- Preload -->
    <link rel="preload" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.13.1/css/bootstrap-select.min.css" as="style">
    <link rel="preload" href="https://cdnjs.cloudflare.com/ajax/libs/lightslider/1.1.6/css/lightslider.css" as="style">
    <link rel="preload" href="<?php echo $part;?>css/slideshow.css?v=<?php echo $todate;?>" as="style">
    <!--END Preload -->

    <script src='https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.13.1/css/bootstrap-select.min.css' async defer ></script>  
   ...
   <link rel="preload" href="http://cdnjs.cloudflare.com/ajax/libs/jquery.lazyload/1.9.1/jquery.lazyload.min.js" as="script">
...
<script>
  ...
  <main>
    ...
    <div class="map-nav">
       <a href="<?php echo $part;?>" class="link_nav" ><?php echo $link_home;?></a> /  <a href="<?php echo $link_pro;?>" class="link_nav"><?php echo $project_name;?></a>  
    </div>  

 


    <section class="container-fluid" style="padding-right: 15px;padding-left: 15px;">
    ...
    <!-- Preload -->
    <link rel="preload" href="<?php echo $part;?>css/w4.css?v=<?php echo $todate;?>" as="style">
    <link rel="preload" href="https://cdnjs.cloudflare.com/ajax/libs/lightslider/1.1.6/css/lightslider.css" as="style">
    <link rel="preload" href="<?php echo $part;?>css/slideshow.css?v=<?php echo $todate;?>" as="style">
    <!--END Preload -->
       ...
       <?php } ?>
              ...
              <div class="img-view"  > 
                  <img src="<?php if($url_img_listing[1]!=''){ echo $url_img_listing[1]; }else{ echo "../../../images/noimages.webp";}?>" class="img-view-1" alt="<?php echo $settings_title;?>" title="<?php echo $settings_title;?>"  >
              </div>
  ...
  <div class="modal-content">
    ...
    <p>Some text in the Modal..</p>
              ...
              <div class="box-view">
                <div class="box-view-type" data-tab="localtion"  id="button_map">
                   <button class="btn btn-location" ><img src="../../../images/icon/icon_location.webp" width="20" class="icon_location"> <?php echo $location_map_title;?></button>
                </div> 
                    ...
                    <!--
                   <button  class="btn btn-enquirenow" onclick="getfocus()"><?php echo $unit_interested_title;?></button>-->
              </div>
      ...
      <?php } ?>
            ...
            <div class="col-xl-3 img-view-sub"  >
              <div style="cursor: pointer;" >
                   <img src="<?php if($url_img_listing[2]!=''){ echo $url_img_listing[2]; }else{ echo "../../../images/noimages.webp";}?>" class="img_r1"   alt="<?php echo $settings_title;?>" title="<?php echo $settings_title;?>"  >
              </div>
              <div style="cursor: pointer;" >
                   <img src="<?php if($url_img_listing[3]!=''){ echo $url_img_listing[3]; }else{ echo "../../../images/noimages.webp";}?>"  alt="<?php echo $settings_title;?>" title="<?php echo $settings_title;?>" >
              </div>
              <div style="cursor: pointer;" >
                   <img src="<?php if($url_img_listing[4]!=''){ echo $url_img_listing[4]; }else{ echo "../../../images/noimages.webp";}?>" class="img_r2"  alt="<?php echo $settings_title;?>" title="<?php echo $settings_title;?>" >
   ...
   <?php if($about!=''){ ?>
    ...
    <?php } ?>
              ...
              <h2 class="detail-margin-top"><?php echo $information_title;?></h2>
      ...
      <?php if($project_id!='' and $project_id!='0'){      ?>
              ...
              <div class="project-detail">
                ...
                <ul class="text">
                  ...
                  <li><p><?php echo $train_station_title;?> : </p> <p><a href="<?php echo $link_station;?>" target="_black"><span><strong><?php if($station_name!=''){ echo $train_station; }else{ echo $na_title;}?> </strong></span></a></p></li>
                  ...
                  <li><p><?php echo $zone_title;?> :</p> <p><a href="<?php echo $url_zone;?>" target="_black"><span><strong><?php if($zone_titles!=''){ echo $zone_titles; }else{ echo $na_title;}?></strong></span></a></p></li>
              ...
              <div class="information">
                ...
                <input type="text" class="form-control-textbox" id="name" hidden  value="<?php echo $heading_h1;?>" name="contact_heading" >
                  ...
                  <div class="form-group row">
                    <div class="col-lg-12">
                      <input type="text" class="form-control" id="contact_name"  placeholder="<?php echo $name_contact_title;?>" name="contact_name" required >
                    </div>
                  ...
                  <div class="form-group row">
                    <div class="col-lg-12">
                      <textarea name="contact_detail" id="contact_detail" cols="30" class="form-control" placeholder="<?php echo $message_contact_title;?>"  ></textarea>
                    </div> 
                  </div>
                  ...
                  <center>
                    <div class="g-recaptcha" style="  font-family: SukhumvitSet-Text;  " data-callback="makeaction"  data-sitekey="6LfQtnglAAAAAPWamZXtjcYnsHfZRmwDKVRtcn-r"></div>
                  </center><br>
...
<?php 
    ...
    $sql = "SELECT *  FROM dbo_data_excel_listing AS data 
           ...
           WHERE data.ex_list_listing_type='$ex_list_listing_type_check' and data.ex_list_public='1' and data.project_id='$project_id' and 
                 data.ex_list_deal_type='$ex_list_deal_type'  and 
                 data.ex_list_bedroom='$ex_list_bedroom_check' and $bed_checks='1' and  data.ex_list_listing_code!='$ex_list_listing_code' and
                 data.ex_list_close='0' and data.ex_list_price>=$budget_start_s and data.ex_list_price<=$budget_end_s or

                 data.ex_list_listing_type='$ex_list_listing_type_check' and data.ex_list_public='1' and data.project_id='$project_id' and 
                 data.ex_list_deal_type='$ex_list_deal_type'  and data.ex_list_bedroom='1' and $bed_checks='0' and 
                 data.ex_list_listing_code!='$ex_list_listing_code' and data.ex_list_close='0' and 
                 data.ex_list_price>=$budget_start_s and data.ex_list_price<=$budget_end_s or

                 data.ex_list_listing_type='$ex_list_listing_type_check' and data.ex_list_public='1' and data.project_id='$project_id' and 
                 data.ex_list_deal_type='$ex_list_deal_type'  and data.ex_list_bedroom='0' and $bed_checks='0'and  
                 data.ex_list_listing_code!='$ex_list_listing_code' and data.ex_list_close='0' and 
                 data.ex_list_price>=$budget_start_s and data.ex_list_price<=$budget_end_s 
...
?>
    <section class="sec-home-detail">
      <div class="container-fluid">
        ...
        <h3 class="detail-center"><?php echo $unit_project_a_title." ".$project_name ;?> 

       <?php if($device=='pc'){?>
                <a href="<?php echo $link_pro;?>" class="btn btn-yellow3" ><?php echo $more_title;?></a>
       <?php } ?>
        </h3> 
         ...
         while($rs = $result->fetch_assoc()){      $n++;  
             ...
             $ex_list_wa=$ex_list_rai+$ex_list_ngan+$ex_list_wa;
              ...
              if($ex_list_deal_type=='ขาย' or $ex_list_deal_type=='1'){ $ex_list_pric=$ex_list_pric;   $sale_text_en="SALE"; $sale_text="ขาย"; }
                     ...
                     }else{  $img_name_list="../../images/noimages.webp" ;  $test1 = "000"; 
 ...
 ?>
              ...
              <li>
                <a href="<?php echo  $part;?>property/<?php echo $lang;?>/<?php echo $ex_list_listing_code;?>">
                  <div class="condo-card-detail">
                    <div class="cover"> 
                        <img src="<?php echo $img_name_list;?>"  class="coverimg" alt="<?php echo $alt_heading;?>" title="<?php echo $alt_heading;?>" loading="lazy" >
                    </div>
                    <div class="detail">
   ...
   <?php        }
       ...
       <?php if($device=='m'){?>
                <center><a href="<?php echo $link_pro;?>" class="btn btn-yellow3" ><?php echo $more_title;?></a></center>
       <?php } ?>
      </div> 
...
<?php } ?>
             ...
             <div id="id02" class="w3-modal modal" style="padding-top:10px;" >
       ...
       <?php } ?>
                  ...
                  <header class="w3-container w3-teal"> 
                    ...
                    class="w3-button w3-display-topright"> &times; </span><!--&times;-->
                    ...
                    <div class="col-xl-12" style="margin-top: 10px;margin-bottom: 30px;">
                      <div class="information2">
                        ...
                        <input type="text" class="form-control-textbox" id="name" hidden  value="<?php echo $heading_h1;?>" name="contact_heading" >
                          ...
                          <div class="form-group row">
                            <div class="col-lg-12">
                              <input type="text" class="form-control" id="contact_name2"  placeholder="<?php echo $name_contact_title;?>" name="contact_name2" required >
                            </div> 
                          </div>
                          <div class="form-group row"> 
                            <div class="col-lg-12">
                         ...
                         <script> // กำหนดปุ่มเป็น disable ไว้ ต้องทำ reCHAPTCHA ก่อนจึงกดได้
                          ...
                          <center><div class="g-recaptcha" data-callback="makeaction"  data-sitekey="6LfQtnglAAAAAPWamZXtjcYnsHfZRmwDKVRtcn-r"></div></center><br>
...
if($ex_list_listing_type=='1' or $ex_list_listing_type=='5' or $ex_list_listing_type=='7' or $ex_list_listing_type=='8' or $ex_list_listing_type=='9' or $ex_list_listing_type=='10' or $ex_list_listing_type=='11'  or $ex_list_listing_type=='12'  ){  //เฉาะคอนโดมิเนียม
      ...
      $sql="SELECT * FROM dbo_data_excel_listing AS data 
          ...
          WHERE   data.ex_list_listing_type='$ex_list_listing_type_check' and data.ex_list_public='1'  and data.ex_list_deal_type='$ex_list_deal_type' and 
                  ...
                  data.ex_list_bedroom='$ex_list_bedroom_check' and $bed_checks='1' and  
                  data.ex_list_listing_code!='$ex_list_listing_code' and   data.ex_list_close='0' and 
                  data.ex_list_price>=$budget_start_s and data.ex_list_price<=$budget_end_s  
                  or 
                  data.ex_list_listing_type='$ex_list_listing_type_check' and data.ex_list_public='1' and 
                  data.ex_list_deal_type='$ex_list_deal_type' and 
                  data.project_id!='$project_id' and data.zone_id='$zone_id'  and 
                  data.ex_list_bedroom='1' and $bed_checks='0' and data.ex_list_listing_code!='$ex_list_listing_code' and   
                  data.ex_list_close='0' and data.ex_list_price>=$budget_start_s and data.ex_list_price<=$budget_end_s  
                  or 
                  data.ex_list_listing_type='$ex_list_listing_type_check' and data.ex_list_public='1'  and 
                  data.ex_list_deal_type='$ex_list_deal_type' and 
                  data.project_id!='$project_id' and data.zone_id='$zone_id'  and 
                  data.ex_list_bedroom='0' and $bed_checks='0' and data.ex_list_listing_code!='$ex_list_listing_code' and 
                  data.ex_list_close='0' and data.ex_list_price>=$budget_start_s and data.ex_list_price<=$budget_end_s  
 ...
 ?>
    ...
    <section class="sec-home-detail_2"  >
      ...
      <div class="container-fluid">
        ...
        <h3 class="detail-center"><?php echo $unit_project_b_title;?> 
            <?php if($device=='pc'){?>
                 <a href="<?php echo $url_zone;?>" class="btn btn-yellow3" ><?php echo $more_title;?></a>
            <?php } ?>
        </h3> 
       ...
       $project_id_2=$rs_project['project_id']; */ 
        ...
        // output data of each row
         while($rs = $result->fetch_assoc()){     $n2++;  //ยูนิตในโครงการใกล้เคียงกัน
              ...
              $ex_list_listing_name_en=$rs['ex_list_listing_name_en'];
              ...
              if($ex_list_deal_type=='ขาย' or $ex_list_deal_type=='1'){ $ex_list_pric=$ex_list_pric;   $sale_text_en="SALE"; $sale_text="ขาย"; }
                     ...
                     if($listing_img_folder!=''){   
                           ...
                           $img_name_list=str_replace(" ","%20",$img_name_list);
                            ...
                            $img_name_list="../../images/noimages.webp" ;  $test1 = "000"; 
              ...
              if($project_id!='0'){
                     ...
                     $project_name=$ex_list_listing_name;
                     $project_name_en=$ex_list_listing_name_en;
              }
 ...
 ?>
   ...
   <?php           }
            ...
            <?php if($device=='m'){?>
                 <center><a href="<?php echo $url_zone;?>" class="btn btn-yellow3" ><?php echo $more_title;?></a></center>
            <?php } ?>
...
<?php
    ...
    $sql_3="SELECT  * FROM   type_project AS pj  
           WHERE pj.project_id!='$project_id_check' and pj.zone_id='$zone_id' and pj.project_name!='' and 
                 pj.project_type='$ex_list_listing_type' and pj.project_listing_count_public!='0' 
           order by pj.project_listing_count DESC  LIMIT 6  ";

     $result_3= $conn->query($sql_3); 
     $rowcount2=mysqli_num_rows($result_3);
          ...
          <div class="col-xl-10">
            <div class="row main-description"> 
              <div class="col-12"> 
                ...
                <h2 class="detail-center"><?php echo $near_project_title;?> </h2> 
...
<?php
        ...
        // output data of each row
         while($rs = $result_3->fetch_assoc()){      $n3++;      
        ...
        $project_img_name=$rs['project_img_webp']; 
         ...
         $link_pro="$baseUrl/search/$lang/all/$project_type/$search_p_id/all/$url_name/1";
          ...
          if($ex_list_listing_type=='1' or $ex_list_total_floors=='' or $ex_list_total_floors=='0'){
            ...
            $ex_list_total_floors_en=$project_total_floors.""; 
             ...
             if($project_img_name!='' ){ 
                 ...
                 $project_img_folder="../../images/project/$project_id/webp/mini_w500/".$project_img_name; 

             }else{ // ถ้าไม่มีภาพ ให้ใช้ภาพของ Listing

                  $project_img_folder="../../images/noimages.webp"; 
        ...
        ////////// End type_asset ////////////////
         ...
         if($lang=='th'){
            ...
            $address=$address_en;
            $project_name_c=$project_name_en;
            $type_name=$type_en;
            $sale_text=$sale_text_en;
            $area_text=$area_en;
                    ...
                    <li >
                      <div class="project2-card-detail">
                        <div class="view-project2">
                          ...
                          <a href="<?php echo $link_pro;?>" target="_black">
                            <div class="img" >
                               <img src="<?php echo $project_img_folder;?>" class="img-project" alt="<?php echo $project_name_c;?>" title="<?php echo $project_name_c;?>" >
                            </div></a>
                          <div class="h3s"><strong></strong> 
                            <a href="<?php echo $link_pro;?>" target="_black">
                            	<?php echo $project_name_c;?>
                            </a>
                          </div>
                          <h4><strong> </strong><?php echo  $address;?></h4> 
                          <h4><strong></strong><?php if($project_unit!='' and $project_unit!='0'){ echo $project_unit; }else{ echo $na_title; } ?></h4>
...
<?php
        ...
        // output data of each row
         while($rs = $result_3->fetch_assoc()){          $n4++;  
 ...
 ?> 
                        ...
                        <div class="carousel-item <?php if($n4==1){?> active <?php } ?>">
                          <div class="view-project">
                            ...
                            <div class="view-project-detail">
                              <div class="view-project-detail-a">
                                    <h3>
                                    	<a href="<?php echo $link_pro;?>" target="_black">
                                    		<?php echo $project_title;?> <?php echo $project_name;?>
                                    	</a>
                                    </h3>
                                    <h4><strong><?php echo $location_title;?></strong><p><?php echo  $address;?></p>
                                    </h4> 
                                    <h4><strong><?php echo $unit_title;?></strong>
                                    <p><?php if($project_unit!='' and $project_unit!='0'){ echo $project_unit; }else{ echo $na_title; } ?></p></h4>
                                    <h4><strong><?php echo $floors_total_title;?></strong>  
                                    <p><?php if($project_total_floors!=''){ echo $project_total_floors; }else{echo $na_title;  } ?></p>
                                    </h4>
                                    <h4><strong><?php echo $train_station_title;?></strong>
                                    <p><?php if($station_name!=''){ echo $train_station; }else{ echo $na_title;}?></p>
                                    </h4>
                                    <h4><strong><?php echo $developer_title;?></strong> 
                                    <p><?php if($project_developer!=''){ echo $developer_name; }else{ echo $na_title;}?></p>
                                    </h4>
                                    <h4><strong><?php echo $completed_title;?></strong>
                                    <p><?php if($project_completed!=''){ echo $project_completed; }else{ echo $na_title; } ?></p></h4>
                              </div>
                            </div>
                        </div>                        
                      </div> 
    ...
    <?php        }
                       ...
                       <a class="carousel-control-prev" href="#itemx4" data-slide="prev" style="    margin-top: 75px; display:flow;">
                        <span class="carousel-control-prev-icon"></span>
                      </a>
                      <a class="carousel-control-next" href="#itemx4" data-slide="next" style="    margin-top: 75px; display:flow;">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header" > 
          ...
          <ul class="nav nav-tabs" role="tablist">
            <li class="nav-item">
              <a class="nav-link photo" href="#photo" role="tab" data-toggle="tab" style="margin-left: 40px;"><?php echo $photo_title;?></a>
            </li>
            <li class="nav-item">
 ...
 <?php if($device=="pc"){ ?> 
              ...
              <div class="col p-0 ">
                <div class="d-flx-combo w-100 carouselx active"> 
                  <p class="des-photo"><?php echo $heading_h1;?> | ฿<?php echo number_format($ex_list_price_check);?> | <?php if($ex_list_bedroom_check==0){ echo $ex_list_bedroom_check; }else{ echo $ex_list_bedroom_check." ".$bedroom_title; } ?> | <?php echo $ex_list_bathroom_check." ".$bathroom_title;?> </p>
                  <!--<div class="btn-span"> 
...
<?php 
    ...
    if($ex_list_img_number!='0'){
          ...
          ?>
                    ...
                    <div id="img-<?php echo $img;?>" data-img-id="<?php echo $img;?>" class="img-wrapper <?php if($img=='1'){?>active<?php }?>"  >
                         <img src="<?php echo $url_img_lists;?>" class="img-wrapper-1 active" id="img-<?php echo $img;?>" data-img-id="<?php echo $img;?>"  alt="<?php echo $settings_title;?>" title="<?php echo $settings_title;?>"  loading="lazy" >
                    </div> 
      <?php  } ?>
               ...
               <?php $img=0;
                     foreach ($url_img_listing as $url_img_lists) {  $img++; ?>
                        ...
                        <li data-thumb-id="<?php echo $img;?>" class="thumb <?php if($img=='1'){ ?> active<?php }?>"  >
                            <img src="<?php echo $url_img_lists;?>" alt="<?php echo $settings_title;?>" title="<?php echo $settings_title;?>"   class="thumb-1" loading="lazy">
                        </li>
               <?php } ?>
 ...
 <?php  } ?>
               ...
               <?php $img=0;
                     foreach ($url_img_listing as $url_img_lists) {  $img++;  ?>
                      <div class="col-4 p-1">  
                        <img id="<?php echo $img;?>" src="<?php echo $url_img_lists;?>" alt="<?php echo $settings_title;?>" title="<?php echo $settings_title;?>" class="img-fluid d-block m-auto" loading="lazy">
                      </div>  
               <?php } ?>
...
<!-- --------------------MOBILE------------------->
                ...
                <div class="row pc-x row-gal">  
                  <div class="col-12 gal-1">   
    ...
    if($ex_list_img_number!='0'){
          ...
          foreach ($url_img_listing as $url_img_lists) {  $img++; ?>
                  ...
                  <div class="carousel-item <?php if($img=='1'){ ?>active <?php } ?>" id="<?php echo $img;?>"  style="transition: -webkit-transform 0s ease-in-out; ">
                    <img src="<?php echo $url_img_lists;?>" alt="<?php echo $settings_title;?>" title="<?php echo $settings_title;?>" class="img-fluid d-block mx-auto" loading="lazy">
   ...
   <?php  }
                  ...
                  <p class="des-photo"><?php echo $heading_h1;?> <br> ฿<?php echo number_format($ex_list_price_check);?> | <?php if($ex_list_bedroom_check==0){ echo $ex_list_bedroom_check; }else{ echo $ex_list_bedroom_check." ".$bedroom_title; } ?> | <?php echo $ex_list_bathroom_check." ".$bathroom_title;?> </p>
...
<?php } ?>            
        ...
        <!-- Preload-->
        <link rel="preload" href="https://polyfill.io/v3/polyfill.min.js?features=default" as="script"> 
        <link rel="preload" href="https://maps.googleapis.com/maps/api/js?key=AIzaSyAI0mXvBUiE73pO0F22BJ2N6asExHtxWSc&callback=initMap&libraries=&v=weekly" as="script"> 
        <!-- END Preload-->
...
<script type="text/javascript">
   ...
   <!-- Preload-->
    ...
    <link rel="preload" href="<?php echo $part;?>js/gallery.js" as="script"> 
   <!-- END Preload-->
...
<?php if($device=="pc"){ ?>
    ...
    $(document).scroll(function() {
      if ( $(document).scrollTop() < 900 ) { 
        $(".information").css("margin-top","auto");
        $(".information").removeClass("active");
      } 
      else if ( $(document).scrollTop() >= 900 && $(document).scrollTop() <= 1200 ) {
        $(".information").css("margin-top","auto");
        $(".information").addClass("active"); 
      }  
      else if ( $(document).scrollTop() >= 1200 ) { 
        $(".information").css("margin-top","250px");
        $(".information").removeClass("active"); 
      }
    });
